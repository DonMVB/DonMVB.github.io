...
1. [[Essential Pattern Matching Tutorial for Grep ‐ Incident Response]]
2. [[Windows 10 11 Auto Start Extensibility Points (ASEPs)]]
3. [[Windows Process Explorer IR Guide (Windows 11)]]
4. [[tcpdump and tshark for the Incident Responder]] and [[wireshark for the Incident Responder]]
